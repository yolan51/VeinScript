...
CASES=("samples/entities.vein:3" "samples/entities_multi.vein:2" "samples/entities_chance.vein:4" "samples/entities_detach.vein:4" "samples/entities_template.vein:2")
