...
CASES=("samples/entities.vein:3" "samples/entities_multi.vein:2" "samples/entities_chance.vein:4" "samples/entities_detach.vein:4" "samples/entities_template.vein:2" "samples/entities_marks.vein:4" "samples/entities_bind.vein:2" "samples/entities_index.vein:2" "samples/entities_filter.vein:2" "samples/entities_ordered.vein:2" "samples/entities_bring_order.vein:2" "samples/entities_bring_rows.vein:2" "samples/bench_folds.vein:2" "samples/builder_defaults.vein:2" "samples/dom_rewire.vein:2" "samples/rows_in_order.vein:1" "samples/events.vein:2" "samples/payload.vein:2" "samples/entities_nested.vein:1" "samples/entities_chars.vein:1" "samples/entities_convert.vein:2" "samples/loops.vein:2" "samples/text_search.vein:1" "samples/text_split_join.vein:1" "samples/math_round.vein:1" "samples/motion.vein:4" "samples/entities_destroy.vein:3" "samples/random_draw.vein:3" "samples/ui_widgets.vein:2" "samples/game_collision.vein:2" "samples/stdlib_events.vein:3" "samples/sigil_names.vein:2" "samples/shape_marks.vein:4" "samples/ui_view.vein:2" "samples/builder_variants.vein:2" "samples/transform_hierarchy.vein:3" "samples/clock_ticked.vein:3" "samples/enum_state.vein:4")
