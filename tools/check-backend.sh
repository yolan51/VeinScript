...
CASES=("samples/entities.vein:3" "samples/entities_multi.vein:2" "samples/entities_chance.vein:4" "samples/entities_detach.vein:4" "samples/entities_template.vein:2" "samples/entities_marks.vein:4" "samples/entities_bind.vein:2" "samples/entities_index.vein:2" "samples/entities_filter.vein:2" "samples/entities_ordered.vein:2" "samples/entities_bring_order.vein:2")
