...
- **Publicators = the shared API** (`shared` shapes/events/builders/functions), reachable across bundles
  ...
  **36 shapes · 39 events · 36 builders · 6 fn · 11 SF**, in **28 publicators**. Four of those names are
